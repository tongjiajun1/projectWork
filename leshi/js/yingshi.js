$(function(){
	...
	//鼠标点击弹出
	$('.ying-wrap>div>ul>li').hover(function(){
		var str1=$(this).index();
		 $(this).find('.product-main>.product-pic>img').addClass('pic-active')
		 $(this).find('.product-main>.product-right').css('width','336px')
	},function(){
		$(this).find('.product-main>.product-pic>img').removeClass('pic-active')
	})
});